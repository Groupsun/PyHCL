...
VL_INLINE_OPT void VALU::_combo__TOP__1(VALU__Syms* __restrict vlSymsp) {
    ...
    // Body
    vlTOPp->ALU__DOT___T_46 = (vlTOPp->io_src_a == vlTOPp->io_src_b);
    vlTOPp->ALU__DOT___T_22 = VL_LTS_III(1,32,32, vlTOPp->io_src_a, vlTOPp->io_src_b);
    vlTOPp->ALU__DOT___T_23 = (vlTOPp->io_src_a < vlTOPp->io_src_b);
				    ...
				    ? ((0x1fU >= (0x3fU 
					   ...
					   >> (0x3fU 
				        ...
				        : 0U) : ((7U 
						 ...
						 ((8U 
						   == (IData)(vlTOPp->io_ALUOp))
						   ? (IData)(vlTOPp->ALU__DOT___T_22)
						   : 
						  ((9U 
						    == (IData)(vlTOPp->io_ALUOp))
						    ? (IData)(vlTOPp->ALU__DOT___T_23)
						    : vlTOPp->io_src_b)))));
...
void VALU::_ctor_var_reset() {
    ...
    ALU__DOT___T_22 = VL_RAND_RESET_I(1);
    ALU__DOT___T_23 = VL_RAND_RESET_I(1);
    ALU__DOT___T_46 = VL_RAND_RESET_I(1);
