...
VL_INLINE_OPT void VAdder::_combo__TOP__1(VAdder__Syms* __restrict vlSymsp) {
    ...
    VAdder* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->Adder__DOT___T_11 = (7U & ((3U & ((IData)(vlTOPp->io_a) 
                                              + (IData)(vlTOPp->io_b))) 
                                       + (IData)(vlTOPp->io_cin)));
    vlTOPp->io_s = (1U & (IData)(vlTOPp->Adder__DOT___T_11));
    vlTOPp->io_cout = (1U & ((IData)(vlTOPp->Adder__DOT___T_11) 
                             >> 1U));
}
...
void VAdder::_ctor_var_reset() {
    ...
    Adder__DOT___T_11 = VL_RAND_RESET_I(3);
